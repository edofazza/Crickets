...
def get_resnet18_model(num_channel=10652):
    length = 10  # Length of each Segment
    model_width = 5  # Width of the Initial Layer, subsequent layers start from here
    problem_type = 'Classification'  # Classification or Regression
    output_nums = 3  # Number of Class for Classification Problems, always '1' for Regression Problems
    return ResNetv2(length, num_channel, model_width, problem_type=problem_type, output_nums=output_nums,
                    pooling='avg', dropout_rate=False).ResNet18()


def get_resnet34_model(num_channel=10652):
    length = 10  # Length of each Segment
    model_width = 5  # Width of the Initial Layer, subsequent layers start from here
    problem_type = 'Classification'  # Classification or Regression
    output_nums = 3  # Number of Class for Classification Problems, always '1' for Regression Problems
    return ResNetv2(length, num_channel, model_width, problem_type=problem_type, output_nums=output_nums,
                    pooling='avg', dropout_rate=False).ResNet34()


def get_resnet50_model(num_channel=10652):
    length = 10  # Length of each Segment
    model_width = 5  # Width of the Initial Layer, subsequent layers start from here
    problem_type = 'Classification'  # Classification or Regression
    output_nums = 3  # Number of Class for Classification Problems, always '1' for Regression Problems
    return ResNetv2(length, num_channel, model_width, problem_type=problem_type, output_nums=output_nums,
                    pooling='avg', dropout_rate=False).ResNet50()
...
if __name__ == '__main__':
    ...
    model_width = 5  # Width of the Initial Layer, subsequent layers start from here
    num_channel = 10652  # Number of Input Channels in the Model
    problem_type = 'Classification'  # Classification or Regression
    output_nums = 3  # Number of Class for Classification Problems, always '1' for Regression Problems
    model = ResNetv2(length, num_channel, model_width, problem_type=problem_type, output_nums=output_nums,
                     pooling='avg', dropout_rate=True).ResNet18()
